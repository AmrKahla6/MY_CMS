                ...
                ?>
                    ...
                    <?php
                        if(isset($_POST['edit_user'])){
                            ...
                            $replace  = str_replace('users.php' , 'user-update.php' , $referer);
                            $url      = $replace .'?user_id='.$user_id;
                            // echo $replace;
                            header("Location: {$url}");

                            //http://localhost/my-cms/backend/user-update.php
                        }
                    ?>
                            ...
                            <div class="card-body">
                                <form action="user-update.php?user_id=<?php echo $_GET['user_id']; ?>" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="user-photo" class="form-control-file" id="post-title" type="file" /><br>
                                        <img class="img-thumbnail" src="../img/users/<?php echo $user_photo; ?>" height="100" width="100" />
                                    </div>
                                    </div>
