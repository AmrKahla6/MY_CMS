                ...
                <main>
                    ...
                    <?php 
                        ...
                        if(isset($_POST['new-post'])) {
                            ...
                            $sql = "INSERT INTO posts (post_category_id, post_title, post_detail, post_image, post_date, post_status, post_author, post_views, post_comment_count, post_tags) 
                                    VALUES (:id, :title, :detail, :image, :date, :status, :author, :views, :comment, :tags)";
                            ...
                            <div class="card-body">
                                <form action="add-new.php" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="post-detail" class="form-control" placeholder="Type here..." id="post-content" rows="9" required>
                                            <?php echo isset($_POST['post-detail'])?$_POST['post-detail']:'' ?>
                                        </textarea>
                                    </div>

                                    <div class="form-group">
                                        <label for="post-tags">Post Tags:</label>
                                        <textarea name="post-tags" class="form-control" placeholder="Tags..." id="post-tags" rows="3" required>
                                            <?php echo isset($_POST['post-tags'])?$_POST['post-tags']:'' ?>
                                        </textarea>
                                    </div>
